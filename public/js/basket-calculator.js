...
var BasketCalculatorClass = function BasketCalculatorClass() {
  ...
  self.sendChangeCountRequest = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(itemId, count) {
      var response;
  ...
  $(document).on('change', self.itemCountInputSelector, function () {
    ...
    self.sendChangeCountRequest($(this).closest(self.basketItemRowSelector).attr('data-item-id'), value).then(function (r) {
    ...
    var value = input.val();
    input.val(++value);
    self.sendChangeCountRequest($(this).closest(self.basketItemRowSelector).attr('data-item-id'), value).then(function () {
      self.calculateBasket();
    });
...
module.exports = __webpack_require__(/*! C:\OpenServer\domains\grandadore\resources\js\basket-calculator.js */"./resources/js/basket-calculator.js");
