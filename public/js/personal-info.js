...
window.flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_1___default.a;
window.flatpickrRussianLocalization = flatpickr_dist_l10n_ru_js__WEBPACK_IMPORTED_MODULE_2__["Russian"];
...
var phoneCodeWasSent = false;
var emailCodeWasSent = false;
$('#phoneChangingTrigger').click(function () {
  var phoneInput = $('#cabinet-phone');
  var codeInput = $('#phoneCode');
    ...
    sendChangingRequest(window.phoneChangingCodeUrl, {
      ...
      if (response.errors) {
        ...
        response.errors.forEach(function (error) {
          phoneAlert.append("<span>".concat(error, "</span>"));
        });
        phoneAlert.show();
      } else {
        phoneCodeWasSent = true;
        phoneAlert.addClass('alert-success').append("<span>".concat(response.message, "</span>")).show();
...
$('#emailChangingTrigger').click(function () {
  var emailInput = $('#cabinet-email');
  var codeInput = $('#emailCode');
  ...
  if (!emailCodeWasSent) {
    sendChangingRequest(window.emailChangingCodeUrl, {
      ...
      if (response.errors) {
        ...
        response.errors.forEach(function (error) {
          emailAlert.append("<span>".concat(error, "</span>"));
        });
        emailAlert.show();
      } else {
        emailCodeWasSent = true;
        emailAlert.addClass('alert-success').append("<span>".concat(response.message, "</span>")).show();
...
function sendChangingRequest(_x, _x2) {
  return _sendChangingRequest.apply(this, arguments);
}

function _sendChangingRequest() {
  _sendChangingRequest = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(url, data) {
    var response;
...
/***/ 10:
/*!*********************************************!*\
  !*** multi ./resources/js/personal-info.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\OpenServer\domains\grandadore\resources\js\personal-info.js */"./resources/js/personal-info.js");
