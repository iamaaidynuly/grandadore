...
var FavoritesBundleClass = function FavoritesBundleClass() {
  ...
  self.initTriggersActives = function () {
    ...
    self.favoriteItems.forEach(function (itemId) {
      self.favoriteActionElements.filter("[data-item-id=\"".concat(itemId, "\"]")).addClass('active');
    });
...
module.exports = __webpack_require__(/*! C:\OpenServer\domains\grandadore\resources\js\favorites-bundle.js */"./resources/js/favorites-bundle.js");
