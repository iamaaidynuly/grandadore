...
var ViewModelClass = function ViewModelClass() {
  ...
  $(".cancel_btn").click(function () {
    var min = $('.irs-min').text();
    var max = $('.irs-max').text();
    var val = self.$rangeInputFrom.prop("value");
...
module.exports = __webpack_require__(/*! C:\OpenServer\domains\grandadore\resources\js\viewModel-bundle.js */"./resources/js/viewModel-bundle.js");
