...
window.ionRangeSlider = ion_rangeslider__WEBPACK_IMPORTED_MODULE_0___default.a; //window.jquery_ui = jquery_ui;
...
$(document).ready(function () {// var w = $(window).width();
  // if (w <= 575) {
...
$('.fas.fa-star.rating').on('click', function () {
  var onStar = parseInt($(this).attr('data-rating'), 10);
  var stars = $(this).parent().children('.fas.fa-star.rating');
...
module.exports = __webpack_require__(/*! /home/poghos/Projects/grandadore/resources/js/product-list.js */"./resources/js/product-list.js");
