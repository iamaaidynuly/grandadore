...
/***/ "./resources/js/lazyLoad-bundle.js":
/*!*****************************************!*\
  !*** ./resources/js/lazyLoad-bundle.js ***!
  \*****************************************/
/*! no exports provided */
...
window.LazyLoadClass = function (params) {
  ...
  self.generatePlaceholder = function (width, height) {
    var placeholder = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"".concat(width, "\" height=\"").concat(height, "\" viewBox=\"0 0 ").concat(width, " ").concat(height, "\">\n                              <rect fill=\"").concat(self.placeholderBgColor, "\" width=\"").concat(width, "\" height=\"").concat(height, "\"/>\n                            </svg>");
    var encoded = encodeURIComponent(placeholder.replace(/[\t\n\r]/gim, '').replace(/\s\s+/g, ' ').replace(/'/gim, '\\i')).replace(/\(/g, '%28').replace(/\)/g, '%29');
    return "data:image/svg+xml;charset=UTF-8,".concat(encoded);
  };

  self.refreshElements = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
  ...
  self.setPlaceholder = function (element) {
    var placeholderSizes = element.attr('data-lazyload-placeholder');

    if (placeholderSizes) {
      var sizes = placeholderSizes.split('x');
      var width = sizes[0];
      var height = sizes[1];
...
/***/ 2:
/*!***********************************************!*\
  !*** multi ./resources/js/lazyLoad-bundle.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/poghos/Projects/grandadore/resources/js/lazyLoad-bundle.js */"./resources/js/lazyLoad-bundle.js");
