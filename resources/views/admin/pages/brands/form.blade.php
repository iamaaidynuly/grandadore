...
@section('content')
    ...
    <form action="{!! $edit?route('admin.brands.edit', ['id'=>$item->id]):route('admin.brands.add') !!}" method="post"
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6">
                <div class="card">
                    <div class="c-title">Изображение (754x734)</div>
                    @if (!empty($item->image))
                ...
                <div class="card">
                    <div class="c-title">Изображение Лого (220x90)</div>
                    @if (!empty($item->image))
                        <div class="p-2 text-center">
                            <img src="{{ asset('u/brands/'.$item->logo_image) }}" alt="" class="img-responsive">
                        </div>
                    @endif
                    <div class="c-body">
                        @file(['name'=>'logo_image'])@endfile
                    </div>
                </div>
