...
@section('titleSuffix')| <a href="{!! route('admin.discountForUser.add') !!}" class="text-cyan"><i
                ...
                <table class="table table-striped m-b-0 columns-middle">
                    ...
                    @foreach($items as $item)
                        <tr class="item-row" data-id="{!! $item->id !!}">
                            ...
                            <td>
                                <a href="{{ route('admin.discountForUser.edit', ['id'=>$item->id]) }}"
                ...
                $.ajax({
                    ...
                    success: function (e) {
                        if (e.success) {
                            loader.removeClass('shown');
                            blocked = false;
                            toastr.success('Группа скидок удалена');
                            modal.modal('hide');
