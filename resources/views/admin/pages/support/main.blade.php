...
@section('titleSuffix')| <a href="{!! route('admin.support.add') !!}" class="text-cyan"><i class="mdi mdi-plus-box"></i>
                ...
                <table class="table table-striped m-b-0 columns-middle">
                    ...
                    @foreach($items as $item)
                        <tr class="item-row" data-id="{!! $item->id !!}">
                            ...
                            @endif
                            <td>
                                <a href="{{ route('admin.support.edit', ['id'=>$item->id]) }}"
