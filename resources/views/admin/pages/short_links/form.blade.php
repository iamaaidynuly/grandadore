...
@section('content')
    <form action="{!! $edit?route('admin.short_links.edit', ['id'=>$item->id]):route('admin.short_links.add') !!}"
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                ...
                <div class="card">
                    @bylang(['id'=>'form_content', 'tp_classes'=>'little-p', 'title'=>'Текст'])
                    <textarea class="ckeditor"
                              name="text[{!! $iso !!}]">{!! old('text.'.$iso, tr($item, 'text', $iso)) !!}</textarea>
                    @endbylang
                </div>
                <div class="card p-2">
                    <label for="url">
            ...
            <div class="col-12 col-lg-6">
                <div class="card">
                    <div class="c-title">Изображение (55 X 55)</div>
                    @if (!empty($item->image))
                        <div class="p-2 text-center">
                            <img src="{{ asset('u/short_links/'.$item->image) }}" alt="" class="img-responsive">
                        </div>
                    @endif
                    <div class="c-body">
