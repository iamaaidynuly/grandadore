...
@section('titleSuffix')| <a href="{!! route('admin.news.add') !!}" class="text-cyan"><i class="mdi mdi-plus-box"></i>
                    ...
                    @foreach($items as $item)
                        <tr class="item-row" data-id="{!! $item->id !!}">
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.gallery', ['gallery'=>'news_item', 'key'=>$item->id]) }}"
                                   {!! tooltip('Галерея') !!} class="icon-btn gallery"></a>
                                {{--<a href="{{ route('admin.video_gallery', ['gallery'=>'news_item', 'id'=> $item->id]) }}"
