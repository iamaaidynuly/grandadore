...
@section('titleSuffix')| <a href="{!! route('admin.main_slider.add') !!}" class="text-cyan"><i
                ...
                <table class="table table-striped m-b-0 columns-middle">
                    ...
                    @foreach($items as $item)
                        <tr class="item-row" data-id="{!! $item->id !!}">
                            <td class="item-title">
                                <img src="{{ asset('u/main_slider/'.$item->image) }}" alt=""
                            ...
                            @endif
                            <td>
                                <a href="{{ route('admin.main_slider.edit', ['id'=>$item->id]) }}"
