...
{{--@section('titleSuffix')| <a href="{!! route('admin.packages.add') !!}" class="text-cyan"><i class="mdi mdi-plus-box"></i> добавить</a>@endsection--}}
@section('content')
    @if(count($items))
        <div class="card">
                ...
                <table class="table table-striped m-b-0 columns-middle">
                    ...
                    @foreach($items as $item)
                        ...
                        <tr class="item-row" data-id="{!! $item->id !!}">
                            ...
                            <td class="item-title">{{ $item->package_price}}</td>
